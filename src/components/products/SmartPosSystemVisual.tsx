      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch">
        <RevealOnScroll>
          <ContentCard className="relative h-full min-h-[34rem] p-6 md:p-8" intensity="strong">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_10%,rgba(34,211,238,0.16),transparent_34%)]" />
            <div className="relative z-10 flex h-full flex-col">
              <div className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-white/10 bg-black/30 p-4">
                <div>
                  <p className="text-[0.65rem] font-bold uppercase tracking-[0.24em] text-cyan-100/55">Retail command view</p>
                  <h3 className="mt-2 font-display text-2xl font-semibold text-white">Smart POS Suite</h3>
                </div>
                <span className="rounded-full border border-cyan-200/20 bg-cyan-200/10 px-4 py-2 text-[0.65rem] font-bold uppercase tracking-[0.2em] text-cyan-100">
              ...
              <div className="mt-6 rounded-3xl border border-cyan-200/15 bg-cyan-200/[0.055] p-5 text-sm leading-7 text-cyan-50/72">
          ...
          <div className="grid h-full gap-4">
            {smartPosOutcomes.map((outcome) => (
              <ContentCard key={outcome.label} className="p-6">
                <p className="text-xs font-bold uppercase tracking-[0.24em] text-cyan-100/60">{outcome.label}</p>
